...
public class NioSocketImplConnectAdvice {
    ...
    static void onExit(
        ...
        if (throwable == null) {
            ...
            message = "JDK NioSocketImpl#connect: address=" + address + " timeout=" + timeout + " fd=" + fdValue;
        } else {
            message = "JDK NioSocketImpl#connect: address=" + address
                      + " timeout=" + timeout
